# 🔒 Security Policy — Jirnyak/Population_game
...
> Project Scope: `Population Game Demographic & Economic Multi-Agent Simulator`
...
We actively maintain and provide critical security updates for the following release lines of **Jirnyak/Population_game**:
...
Security engineering in Jirnyak/Population_game is guided by the following domain-specific threat vector analyses:

### 1. Negative Population Overflow
* **Description**: Integer underflow resulting in negative citizens generating positive tax.
...
If you discover a security flaw or exploit vector in **Jirnyak/Population_game**, do **NOT** post it publicly in open issues or discussions.

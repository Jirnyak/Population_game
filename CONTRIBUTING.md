...
Thank you for your interest in contributing to **Jirnyak/Population_game**. This project operates under strict technical standards: deep mathematical and domain correctness, zero-slop code, explicit typing, and zero unverified assumptions.
...
1. **Demographic Age-Cohort Transitions**:  Population aging must decrement exact yearly cohorts without rounding loss.
2. **Labor Market Equilibrium**:  Employment supply and demand must clear wages iteratively with supply elasticity.
3. **Mortality Matrix Calibration**:  Life expectancy calculations must follow Gompertz-Makeham mortality distribution laws.
4. **60 FPS Agent Rendering**:  Spatial binning for agent interaction lookups to guarantee smooth real-time visualization.
...
### 2.1 Prerequisites
* **Tech Stack**: `JavaScript / Canvas 2D / Web Audio API`
